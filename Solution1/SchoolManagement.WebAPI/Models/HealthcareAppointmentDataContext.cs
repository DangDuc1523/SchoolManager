...
public partial class HealthcareAppointmentDataContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ClassId).HasName("PK__Classes__CB1927A0C3E86F34");
        ...
        {
            entity.HasKey(e => e.ClassSubjectId).HasName("PK__Class_Su__79A9733965E11D43");
        ...
        {
            entity.HasKey(e => e.GradeId).HasName("PK__Grades__54F87A37AAA545CC");
        ...
        {
            entity.HasKey(e => e.StudentId).HasName("PK__Students__32C52A79EA7D5FC5");
        ...
        {
            entity.HasKey(e => e.SubjectId).HasName("PK__Subjects__AC1BA3885DC04947");
        ...
        {
            entity.HasKey(e => e.TimetableId).HasName("PK__Timetabl__68413F403C467B85");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCACA0E8E011");

            entity.HasIndex(e => e.Username, "UQ__Users__536C85E47D5307BF").IsUnique();
